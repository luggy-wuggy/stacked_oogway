...
String parameterToString(dynamic value) {
  ...
  if (value is DeductibilityType) {
    return DeductibilityTypeTypeTransformer().encode(value).toString();
  }
  if (value is PassFailOrNotReported) {
    return PassFailOrNotReportedTypeTransformer().encode(value).toString();
  }
  if (value is PassFailOrOptOut) {
    return PassFailOrOptOutTypeTransformer().encode(value).toString();
  }
  if (value is PassFailOrPartial) {
    return PassFailOrPartialTypeTransformer().encode(value).toString();
  }
  if (value is PassFailOrRemediated) {
    return PassFailOrRemediatedTypeTransformer().encode(value).toString();
  }
