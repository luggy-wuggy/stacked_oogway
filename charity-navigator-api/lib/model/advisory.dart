...
class Advisory {
  /// Returns a new [Advisory] instance.
  Advisory({
    this.advisoryID,
    this.severity,
    this.datePublished,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Advisory &&
  ...
  @override
  String toString() => 'Advisory[advisoryID=$advisoryID, severity=$severity, datePublished=$datePublished, dateRemoved=$dateRemoved, dateModified=$dateModified, organization=$organization, sources=$sources]';
  ...
  /// Returns a new [Advisory] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Advisory fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<Advisory> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(Advisory.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <Advisory>[];

  static Map<String, Advisory> mapFromJson(dynamic json) {
    final map = <String, Advisory>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = Advisory.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of Advisory-objects as value to a dart map
  static Map<String, List<Advisory>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<Advisory>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = Advisory.listFromJson(
            value,
