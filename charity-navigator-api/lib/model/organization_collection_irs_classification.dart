...
class OrganizationCollectionIrsClassification {
  /// Returns a new [OrganizationCollectionIrsClassification] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrganizationCollectionIrsClassification &&
  ...
  @override
  String toString() => 'OrganizationCollectionIrsClassification[subsection=$subsection, foundationStatus=$foundationStatus, deductibility=$deductibility, deductibilityDetail=$deductibilityDetail, deductibilityCode=$deductibilityCode, nteeCode=$nteeCode, nteeClassification=$nteeClassification, nteeLetter=$nteeLetter, nteeType=$nteeType, nteeSuffix=$nteeSuffix, affiliation=$affiliation, groupName=$groupName, exemptOrgStatus=$exemptOrgStatus, exemptOrgStatusCode=$exemptOrgStatusCode, rulingDate=$rulingDate, assetAmount=$assetAmount, incomeAmount=$incomeAmount, latest990=$latest990, filingRequirement=$filingRequirement, accountingPeriod=$accountingPeriod, classification=$classification]';
  ...
  /// Returns a new [OrganizationCollectionIrsClassification] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OrganizationCollectionIrsClassification fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<OrganizationCollectionIrsClassification> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(OrganizationCollectionIrsClassification.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <OrganizationCollectionIrsClassification>[];

  static Map<String, OrganizationCollectionIrsClassification> mapFromJson(dynamic json) {
    final map = <String, OrganizationCollectionIrsClassification>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = OrganizationCollectionIrsClassification.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of OrganizationCollectionIrsClassification-objects as value to a dart map
  static Map<String, List<OrganizationCollectionIrsClassification>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<OrganizationCollectionIrsClassification>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = OrganizationCollectionIrsClassification.listFromJson(
            value,
